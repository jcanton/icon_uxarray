...
- 🎯 Entry points to execute your program using `python -m <icon_uxarray>` or `$ icon_uxarray` with basic CLI argument parsing.
...
```py
from icon_uxarray import BaseClass
from icon_uxarray import base_function
